---
title: "Cyclistic DA Report - with code"
...
```{r LoadPackagesAndData, echo= T, error=F, warning=F, message=F, results="hide"}
...
```{r quickfix, echo= T, error=F, warning=F, message=F, results="hide"}
...
```{r analysis, echo= T, error=F, warning=F, message=F, results="hide"}
...
```{r SumStats, echo=T, error=F, warning=F, message=F}
