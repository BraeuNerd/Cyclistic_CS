...
MoDowTile <- CyclisticData %>%
  ...
  theme_minimal() +
  labs(caption = "Figure 6. Number of rides by day and month by each type of customer from Nov. 2020 to Oct. 2021",
       x = "Month",
       y = NULL,
...
hodtiles <- CyclisticData %>%
  ...
  facet_grid(rows = vars(member_casual)) +
  theme_minimal() +
  labs(caption = "Figure 7. Number of rides by hour of each day by each type of customer from Nov. 2020 to Oct. 2021",
       x = "Hour",
       y = NULL,
       fill = "Number of rides") +
  scale_fill_viridis(option = "viridis") + 
