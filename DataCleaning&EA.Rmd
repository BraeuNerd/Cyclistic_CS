...
summary(cyclistic)
dim(cyclistic) #5,378.531 x 13

#Add new columns for: Day, Month, Year, DayOfWeek (dow), time of day (tod), Season, ride_length
...
dim(cyclistic) # 5378531 x 21
dim(Cyclistic_Data) # 5377138 x 21
...
write.csv(Cyclistic_Data, "Data/CyclisticData.csv")
